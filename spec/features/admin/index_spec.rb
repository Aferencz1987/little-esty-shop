...
RSpec.describe 'Admin' do
  ...
  it 'shows incomplete invoices sorted by date ' do
    ...
    @invoice_1 = @customer_1.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_2 = @customer_1.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_3 = @customer_2.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_4 = @customer_2.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_5 = @customer_3.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_6 = @customer_3.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_7 = @customer_4.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_8 = @customer_4.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_9 = @customer_5.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
    @invoice_10 = @customer_5.invoices.create!(status: :in_progress, merchant_id: @merchant_1.id)
